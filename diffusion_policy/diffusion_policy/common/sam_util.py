...
def generate_mask_from_image(image_path: str, ontology_dict: dict) -> np.ndarray:
    """
...
def visualize_mask(image_path: str, detections: sv.Detections):
    """
...
if __name__ == '__main__':
    ...
    # Generate the mask
    try:
        mask = generate_mask_from_image(dummy_image_path, ontology)
