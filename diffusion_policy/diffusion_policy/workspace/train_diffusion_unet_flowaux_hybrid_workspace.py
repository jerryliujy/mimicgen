...
from diffusion_policy.policy.diffusion_unet_hybrid_flowaux_policy import DiffusionUnetHybridFlowauxPolicy
...
class TrainDiffusionUnetHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None, local_rank=-1):
        ...
        # configure model
        self.model: DiffusionUnetHybridFlowauxPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetHybridFlowauxPolicy = None
