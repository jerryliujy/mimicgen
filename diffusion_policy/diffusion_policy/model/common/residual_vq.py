"""
Copy the code from https://github.com/jayLEE0301/vq_bet_official/blob/main/vector_quantize_pytorch/vector_quantize_pytorch.py.
"""
...
from diffusion_policy.model.common.vector_quantize import VectorQuantize
